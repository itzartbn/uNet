...
public class StudentAtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnreg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentReg = new Intent(StudentAtivity.this, RegisterActivity.class);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(textMail)){
                    Toast.makeText(StudentAtivity.this,"Please enter your Email", Toast.LENGTH_SHORT).show();
                    editTextLoginMail.setError("Email Required");
                    editTextLoginMail.requestFocus();
                } else if (TextUtils.isEmpty(textPwd)) {
                    Toast.makeText(StudentAtivity.this,"Please enter the password", Toast.LENGTH_SHORT).show();
        ...
        authProfile.signInWithEmailAndPassword(textMail, textPwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Intent loginToHome = new Intent(StudentAtivity.this, UserProfileActivity.class);
                    startActivity(loginToHome);
                    Toast.makeText(StudentAtivity.this,"Login Successful", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Toast.makeText(StudentAtivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
